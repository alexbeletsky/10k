...
var $earnings=$('<span class="earnings">'+summary.toString()+'</span>').hide();$('.badges').append($earnings);$earnings.fadeIn('fast');return;}
...
$('.badges').hide().empty();$('.border').css('background','#004d69');$('button.submit').bind('click',function(){var account=$('#github-account').val();setTimeout(startProgress(account),200);event.preventDefault();});$('#github-account').live('keyup',function(event){var account=$('#github-account').val();if(account!=''&&event.keyCode==13){setTimeout(startProgress(account),200);}
